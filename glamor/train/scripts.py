...
def train_glamor(env_cls,
    ...
    if include_labels is None:
        ...
        def include_fn(key): return key in include_labels
...
def train_glamor_atari(game='pong',
    ...
    # env
    def env_cls(): return AnnotatedAtariEnv(game=game,
...
def train_glamor_control(env_name='point_mass/easy',
    ...
    # env
    def env_cls(): return AnnotatedDMControl(domain_name=domain_name,
                                             task_name=task_name,
