...
class Impala(nn.Module):
	...
	def __init__(self, obs_shape, state_size, dropout_p=0, group_norm=True):
		...
		self.block1 = ImpalaBlock(in_channels=in_channels, channels=16, group_norm=group_norm)
		self.block2 = ImpalaBlock(in_channels=16, channels=32, group_norm=group_norm)
		self.block3 = ImpalaBlock(in_channels=32, channels=32, group_norm=group_norm)
		...
		self.out_size, self.out_shape = out.shape[0] * out.shape[1] * out.shape[2], out.shape
