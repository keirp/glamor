...
class AnnotatedDMControl(Env):
	...
	def __init__(self,
				 ...
				 diagonal=False,
				 seed=None):
		self.env = suite.load(domain_name=domain_name, task_name=task_name, task_kwargs=dict(random=seed))
	...
	def step(self, action):
		...
		info = EnvInfo(traj_done=done, labels=self.static_labels, goal_labels=self.static_labels)
